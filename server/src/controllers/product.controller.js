    ...
    try {
        ...
        // --- BUG FIX: Prevent Data Loss on Category Change ---
        // Only modify variants and sizes if the category is 'Clothing'.
        // Otherwise, preserve the existing data.
        if (category === 'Clothing') {
            ...
            // If the category is not 'Clothing', we don't clear the variants.
            // We just update the main stock count. This prevents data loss.
