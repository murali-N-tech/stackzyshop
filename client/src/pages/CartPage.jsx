      ...
      <div className="container mx-auto px-4 py-8 animation-fade-in">
        ...
        {cartItems.length === 0 ? (
          <div className="text-center py-20 bg-gray-50 rounded-lg shadow">
            ...
            <p className="text-gray-500 mt-2 mb-6">Looks like you haven't added any items yet.</p>
            <Link to="/">
              <Button>
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="lg:col-span-2 bg-white p-6 rounded-lg shadow-md">
              <div className="space-y-6">
                {cartItems.map((item) => (
                  <div key={item._id} className="flex flex-col sm:flex-row items-center justify-between border-b pb-6 last:border-b-0">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white p-6 rounded-lg shadow-md sticky top-24">
                ...
                <div className="mb-6">
                  {!coupon ? (
                    <form onSubmit={applyCouponHandler}>
                      <label className="text-sm font-medium text-gray-700 flex items-center gap-2 mb-2"><FaGift /> Have a coupon?</label>
                      <div className="flex">
                        <input type="text" value={couponCode} onChange={(e) => setCouponCode(e.target.value.toUpperCase())} placeholder="Enter Code" className="w-full p-2 border rounded-l-md focus:ring-2 focus:ring-blue-500" />
                ...
                <Button onClick={checkoutHandler} className="w-full text-lg py-3">
                  Proceed to Checkout
                </Button>
              </div>
            </div>
